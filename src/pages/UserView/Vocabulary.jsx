...
const VocabularyPage = () => {
  ...
  if (isLoading) {
    return (
      <div className="bg-cover bg-center bg-no-repeat w-auto h-[88vh]" style={{backgroundImage:`url(${bg})`}}>
  ...
  return (
    <div className=" mx-auto p-6 text-center min-h-[90vh]  bg-gradient-to-br from-blue-50 to-white bg-cover bg-center bg-no-repeat"  style={{backgroundImage:`url(${bg})`}}>
      <div className=" text-black">
        <a href="/">
        <h1 className="text-left flex items-center gap-1"><span><HiArrowNarrowLeft /></span> Back to lesson</h1>
        </a>
      </div>
